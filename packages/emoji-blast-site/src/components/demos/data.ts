...
const more: DemoData[] = [
	...
	},
	{
		...
		disableButtonTime: 6000,
		name: "Everything Everywhere All At Once",
	},
];

const shenanigans: DemoData[] = [
	{
		blaster: () => {
...
and the third consists of the UFO flying off the page.`,
		disableButtonTime: 4000,
		name: "Nope",
	},
];

export const demos = { basic, more, shenanigans };

export type DemosGroup = keyof typeof demos;
