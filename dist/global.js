	...
	const n = [
		...
		d = (t = {}) => {
			...
			const E = {
				...
				C = e(v),
				V = [];
			for (let t = 0; t < C; t += 1) V.push(new o(j));
			!(function (t) {
		...
		u = () => 700 + Math.floor(1401 * Math.random());
	(window.emojisplosion = d),
		(window.emojisplosions = (t = {}) => {
			const { interval: i = u, scheduler: o = setTimeout } = t;
			let n = !1;
			const s = () => {
					d(t);
				},
				a = () => {
					n || ("visible" === document.visibilityState && s(), o(a, e(i)));
				};
			return (
				o(a, 0),
				{
